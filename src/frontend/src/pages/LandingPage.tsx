    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <div className="w-16 h-16 rounded-2xl ai-gradient flex items-center justify-center mx-auto mb-6 shadow-glow">
            ...
            <p className="text-muted-foreground text-lg mb-8">
              Create your store for free. No credit card required. Built on the
              decentralized web—your store, your rules.
            </p>
            <Link to="/login">
              <Button
                size="lg"
